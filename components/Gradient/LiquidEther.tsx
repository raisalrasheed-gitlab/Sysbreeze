...
class Viscous extends ShaderPass {
    ...
    updateViscous(viscous: number, iterations: number, dt: number) {
        if (!this.uniforms) return;
...
class Poisson extends ShaderPass {
    ...
    updatePoisson(iterations: number) {
...
class Simulation {
    ...
    update() {
        ...
        this.advection.updateAdvection(this.options.dt, this.options.isBounce, this.options.BFECC);
        ...
        if (this.options.isViscous) {
            const v = this.viscous.updateViscous(
        ...
        const pressure = this.poisson.updatePoisson(this.options.iterations_poisson);
        if (pressure) {
...
class WebGLManager implements LiquidEtherWebGL {
    ...
    constructor(props: WebGLManagerProps) {
        ...
        this.init(props.paletteTex, props.bgVec4);
...
export default function LiquidEther({
    ...
    useEffect(() => {
        ...
        if (webgl.autoDriver) {
            ...
            // Note: mouse.autoIntensity and takeoverDuration are in MouseClass directly
